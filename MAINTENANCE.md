...
|---|---|---|---|---|
| `PLDI/PLDI/2027/cfp` | ok | 4 | 2026-09-16 | re-checking stored page https://pldi27.sigplan.org/ |
| `POPL/POPL/2027/cfp` | ok | 3 | 2026-09-16 | re-checking stored page https://popl27.sigplan.org/dates |
| `CAV/CAV/2027/cfp` | ok | 4 | 2026-09-16 | re-checking stored page https://conferences.i-cav.org/2027/; validation failed: round 1 author response dates are given but author_response_quote is null; quote the page or set them to null; round 1 notification is given but notification_quote is null; quote the page or set notification to null |
| `ETAPS/ESOP/2027/cfp` | ok | 3 | 2026-09-16 | re-checking stored page https://etaps.org/2027/cfp/ |
| `ICFP/ICFP/2027/cfp` | ok | 3 | 2026-09-16 | re-checking stored page https://icfp27.sigplan.org/ |
| `SPLASH/OOPSLA/2026/cfp` | ok | 5 | 2026-09-16 | re-checking stored page https://2026.splashcon.org/track/oopsla-2026 |
| `SPLASH/OOPSLA/2027/cfp` | ok | 4 | 2026-09-16 | re-checking stored page https://conf.researchr.org/track/splash-2027/splashoopsla2027 |
