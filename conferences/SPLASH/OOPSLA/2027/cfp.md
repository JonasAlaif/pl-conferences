SPLASH 2027 - OOPSLA - SPLASH 2027

SPLASH 2027

Sun 10 - Fri 15 October 2027 Prague, Czechia
...
*   Contact
*   Review Process
    *   **NEW THIS YEAR:** Desk Rejection and Abuse of the Review Process
    *   Reviewing Standards
*   Reserve Reviewer Policy
*   Submissions
    *   **NEW THIS YEAR:** Submission Limits
    *   Template
    *   Page Limit
    *   Anonymity
...
OOPSLA 2027 will have two rounds of reviewing, with the Round 1 submission deadline October 14, 2026 and Round 2 submission deadline April 7, 2027 (AoE). All deadlines are firm. New papers may be submitted to either round. Papers accepted in either round will be published in the 2027 volume of PACMPL(OOPSLA) and invited to present in-person at the SPLASH conference in 2027. (Remote presentations will not be possible.)

Please be aware of the following practices in the OOPSLA review process:

*   At least one author of a paper submission must be registered as a Reserve Reviewer as per the Reserve Reviewer Policy.

*   As in OOPSLA’26, the decisions “Conditional Accept” and “Minor Revision” are merged into a single “Minor Revision” outcome. (See Paper outcomes.)

*   Papers rejected from OOPSLA 2026 (in either round) may be submitted to OOPSLA 2027: the no-resubmission rule applies only within a single year. (See Paper outcomes.)

# Contact

You can reach the two RC Chairs (Nadia Polikarpova and Ilya Sergey) through this email:

oopsla-2027-rc-chairs@googlegroups.com
...
PACMPL(OOPSLA) has two rounds of reviewing. Each paper that proceeds to full review receives at least three reviews and an author response. Papers may initially be assigned two reviewers; a paper assessed by both as clearly below the bar, with high confidence, may be rejected at that stage without a third review or author response.

At the end of each round, each paper will receive one of the four following decisions:

**Accept**: Your paper will appear in the upcoming volume of PACMPL(OOPSLA).

**Reject**: Your paper will not appear in the upcoming volume of PACMPL(OOPSLA). In addition, a paper that is rejected in Round 1 is not allowed to be resubmitted in Round 2. A paper is considered a resubmission if, in the judgment of the Chairs, it is substantially similar to the original submission. This restriction applies only within OOPSLA 2027: a paper that is rejected in Round 2 is allowed to resubmit to Round 1 of OOPSLA 2028, and papers rejected from OOPSLA 2026 (in either round) are welcome at OOPSLA 2027.
...
## Desk Rejection and Abuse of the Review Process

The Chairs may desk-reject a submission without full review if it violates the policies in this call, or if the Chairs, in consultation with an Associate Chair or reviewer, judge it clearly below the bar for OOPSLA. Desk-rejected papers receive a brief notification and count as rejected for the no-resubmission rule.

Submitting several papers that are each consistently below the bar is an abuse of the review process. Where such a pattern is identified in submissions by the same author(s), the Chairs may reject all their remaining submissions without further review and may report the case to the SIGPLAN Executive Committee.

## Reviewing Standards

Reviews must reflect the reviewer’s own reading and assessment of the paper. Reviewers may not upload submissions, in whole or in part, to third-party AI services; submissions are confidential. Associate Chairs check reviews for quality; reviews that do not meet this standard are discarded and replaced, and the reviewer will not be invited to serve again. Authors who believe a review does not engage with their paper should say so in the author response; the Chairs will investigate.
...
Reserve reviewers should expect to be asked to review one or more submissions under RC deadlines and standards. We will do our best to assign papers that closely match expertise (hence the need for TPMS registration). Low-effort reserve reviews may result in desk rejection of the associated submission(s).
...
*   every senior author of the paper satisfies one or more of these criteria:
    ...
    *   is chairing a major SIGPLAN conference in 2026-2028;
...
It is possible for one person to serve as the reserve reviewer for more than one paper. Please enter the seniority/reserve reviewer availability information for each such paper (preferably identically for the same person across their different submissions).

# Submissions

## Submission Limits

**NEW THIS YEAR:** No individual may be an author of more than **5** submissions in a given round, including no more than **2** submissions that have no senior authors (as defined in the Reserve Reviewer Policy).

Submissions exceeding these limits will be desk-rejected, starting from the most recently submitted. Exceptions must be requested from the Chairs **at least one week before the deadline**.
...
Initial submissions must be at most 23 pages using the template. This page limit does not include required statements, references, or supplementary material (such as appendices). However, papers must be self-contained; reviewers are under no obligation to read the supplementary material. Revisions can correspondingly go up to a maximum of 25 pages. This includes papers given a minor or major revision in 2026.
...
Please submit using HotCRP: **https://oopsla27.hotcrp.com/**

## Use of Generative AI

OOPSLA follows the ACM Policy on Authorship and its FAQ on generative AI. Citations/references to non-existed work and claims of results or artifacts that do not exist are grounds for desk rejection. We run automated checks on references.

# Publication

The official publication date is the date the journal is made available in the ACM Digital Library. The journal issue and associated papers accepted in Round 1 (OOPSLA1) will be published no earlier than April 1, 2027, while those accepted in Round 2 (OOPSLA2) will be published no earlier than October 1, 2027. The official publication date affects the deadline for any patent filings related to published work.

### *Important update on ACMs open access publishing model for 2027 ACM Conferences!*
...
*Clarity*: The paper presents its contributions, methodology, and results clearly and concisely. Clarity is assessed on its own; a paper that reviewers cannot understand with reasonable effort, or whose prose is so verbose and formulaic that reading it is not worth the effort, may be rejected for that reason alone.
...
### *May I use AI tools to write my paper?*

Yes, within the policy above; you remain responsible for every claim and reference and for the paper being readable.
...
*   ##### Aws AlbarghouthiAssociate Chair

    ##### University of Wisconsin-Madison


*   ##### Jonathan AldrichAssociate Chair

    ##### Carnegie Mellon University


*   ##### Matthew FlattAssociate Chair

    ##### University of Utah


*   ##### Stephen N. FreundAssociate Chair

    ##### Williams College

*   ##### Robbert KrebbersAssociate Chair

    ##### Radboud University Nijmegen

    ##### Netherlands

*   ##### Sasa MisailovicAssociate Chair

    ##### University of Illinois Urbana-Champaign


*   ##### Hakjoo OhAssociate Chair

    ##### Korea University

    ##### South Korea

*   ##### Azalea RaadAssociate Chair

    ##### Imperial College London; Soteria Tools
